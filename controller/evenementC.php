...
class evenementC {
    ...
    {
        //$sql="SElECT * From employe e inner join formationphp.employe a on e.cin= a.cin";
        $sql="SElECT * From evenement WHERE categorie='Dessert' ";
        $db = config::getConnexion();
        try
        {
        $liste=$db->query($sql);
    ...
    {
        //$sql="SElECT * From employe e inner join formationphp.employe a on e.cin= a.cin";
        $sql="SElECT * From evenement WHERE categorie='Traditionel'";
        $db = config::getConnexion();
        try
        {
        $liste=$db->query($sql);
    ...
    {
        //$sql="SElECT * From employe e inner join formationphp.employe a on e.cin= a.cin";
        $sql="SElECT * From evenement WHERE categorie='Autre'";
        $db = config::getConnexion();
        try
        {
        $liste=$db->query($sql);
    ...
    {
        //$sql="SElECT * From employe e inner join formationphp.employe a on e.cin= a.cin";
        $sql="SElECT * From evenement WHERE categorie='Dessert'  LIMIT 0,1";
        $db = config::getConnexion();
        try
        {
        $liste=$db->query($sql);
    ...
    {
        //$sql="SElECT * From employe e inner join formationphp.employe a on e.cin= a.cin";
        $sql="SElECT * From evenement WHERE categorie='Dessert' OR categorie='lies aux animaux' LIMIT 1,1";
        $db = config::getConnexion();
        try
        {
        $liste=$db->query($sql);
    ...
    {
        //$sql="SElECT * From employe e inner join formationphp.employe a on e.cin= a.cin";
        $sql="SElECT * From evenement WHERE categorie='Dessert' OR categorie='lies aux animaux' LIMIT 2,2";
        $db = config::getConnexion();
        try
        {
        $liste=$db->query($sql);
