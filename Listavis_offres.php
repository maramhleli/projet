   ...
   <center> <table border=3 class="table table-dark table-striped"></center>
        ...
        ?>
            <tr>
                ...
                <td>
                    <a href="deleteavis_offres.php?id_avis=<?php echo $avis_offres['id_avis']; ?>"class="btn cur-p btn-outline-warning">delete</a>
                </td>
            </tr>
        <?php
        }
    ...
    <form method="POST" action="addoffres.php">
                        ...
                        <div class="button_block"><button type="submit" class="btn cur-p btn-outline-warning" >back</button></div>
